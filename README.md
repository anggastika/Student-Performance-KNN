...
• Find the “optimal” number of neighbors to use.
...
• L1 norm (Manhattan): || (x1,y1), (x2,y2) ||1 = |x1 – x2| + |y1 – y2|
• L2 norm (Euclidean): || (x1,y1), (x2,y2) ||2 = sqrt( (x1 – x2)^2 + (y1 – y2)^2 )
• L∞ norm (Chebyshev): || (x1,y1), (x2,y2) ||∞ = max{ (x1 – x2), (y1 – y2) }
